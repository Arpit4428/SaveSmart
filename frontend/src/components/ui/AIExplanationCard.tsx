...
export function AIExplanationCard({
  ...
  return (
    <div
      className={`rounded-xl border border-slate-200/80 bg-slate-50/40 shadow-2xs transition-all ${className}`}
    >
      {/* Top Banner & Control Bar */}
      <div className="p-4 flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-200/60 bg-white/70">
        <div className="flex items-start gap-2.5">
          ...
          <div>
            <div className="flex flex-wrap items-center gap-2">
              <span className="text-[10px] font-bold text-slate-700 bg-slate-100 border border-slate-200 px-2 py-0.5 rounded uppercase tracking-wider">
                AI Explanation
              </span>
